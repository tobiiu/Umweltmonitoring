    ...
    html.Div(className='flex flex-wrap -mx-2 mb-6', children=[
        ...
        html.Div(className='w-full md:w-2/3 px-2 mb-4', children=[
            ...
            dash_table.DataTable(
                ...
                style_table={'overflowX': 'auto', 'backgroundColor': '#1F2937'}, # Dunkler Hintergrund für Tabellencontainer
                style_cell={
                    'textAlign': 'left',
                    'backgroundColor': '#1F2937', # Dunkler Hintergrund für Zellen
                    'color': 'white', # Weißer Text
                    'padding': '10px',
                    'border': '1px solid #374151' # Dezenter Rahmen
                },
                style_header={
                    'backgroundColor': '#374151', # Dunklerer Hintergrund für Header
                    'fontWeight': 'bold',
                    'color': 'white', # Weißer Text
                    'border': '1px solid #374151' # Dezenter Rahmen
                }
...
def update_dashboard_content(n_intervals):
    ...
    map_figure.update_layout(
        mapbox_style="open-street-map", # Sie können 'carto-darkmatter' für einen dunkleren Kartenstil versuchen
